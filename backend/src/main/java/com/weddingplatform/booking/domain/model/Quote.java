...
public record Quote(Long id, String uuid, Long weddingId, Long vendorServiceId, Long requestedById,
    String status, LocalDate eventDate, Integer guestCount, String customRequirements,
